            ...
            if ($this->_requestHandShake != RequestHandshake::HSHK_OK){
                ...
                switch ($this->_requestHandShake){
                    ...
                    case RequestHandshake::HSHK_ERR_UA_API_NO_PPASS:
                        throw new RequestException("{$errStr} Portal authentication is disabled over API calls.", $this->_requestHandShake);
                    ...
                    case RequestHandshake::HSHK_ERR_SM_SUBMITTED:
                        throw new RequestException("{$errStr} The scheduled message is already submitted.", $this->_requestHandShake);
                    ...
                    // GROUP ID: 15
                    case RequestHandshake::HSHK_ERR_MR_TEMPLATE_ID:
