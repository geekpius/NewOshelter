 ...
 */
    ...
    abstract class Request {
        ...
        private static $_targetAPIVersion = "v3";
        ...
        protected function initRequest(){
            ...
            // set the request URL
            $this->_requestURL = "{$urlScheme}://api.{$host}:{$connPort}/".self::$_targetAPIVersion."/{$this->_requestResource}";
        }
        ...
        protected function createDataWriter(){
            ...
            $dataWriter = DataWriter::create($this->_contentType);
        ...
        private function prepareHeader(){
            $headers = array("Host: api.".self::$_gHost,
