...
class ComposerAutoloaderInitec12ffc76e7e9fd2117533448ccaa5ee
{
    ...
    public static function getLoader()
    {
        ...
        if ($useStaticLoader) {
            $includeFiles = Composer\Autoload\ComposerStaticInitec12ffc76e7e9fd2117533448ccaa5ee::$files;
        } else {
            $includeFiles = require __DIR__ . '/autoload_files.php';
        }
        foreach ($includeFiles as $fileIdentifier => $file) {
            composerRequireec12ffc76e7e9fd2117533448ccaa5ee($fileIdentifier, $file);
        }
...
function composerRequireec12ffc76e7e9fd2117533448ccaa5ee($fileIdentifier, $file)
{
