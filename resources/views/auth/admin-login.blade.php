            ...
            <div class="card auth-card shadow-lg">
                <div class="card-body">
                    <div class="px-3">
                        ...
                        <form class="form-horizontal auth-form my-4" id="formSignIn" method="POST" action="{{ url('landlord/login') }}">
                            @csrf
                    ...
                    <div class="m-3 text-center text-muted">
                        <p class="">Don't have an account ?  <a href="{{ route('host.register') }}" class="text-danger ml-2">Free Sign Up</a></p>
                    </div>
                </div><!--end card-body-->
            </div><!--end card-->
