                ...
                <div class="card-body">
                    <div class="px-3">
                        ...
                        <div class="text-center auth-logo-text">
                            <h4 class="mt-0 mb-3 mt-5">Sign Up Real Home Host Account</h4>
                            <p class="text-muted mb-0">Fill Your Info Real Home.</p>  
                        </div> <!--end auth-logo-text-->  

                        
                        <form class="form-horizontal auth-form my-4" id="formSignup" method="POST" action="{{ url('landlord/register') }}">
                            @csrf
                    ...
                    <div class="m-3 text-center text-muted">
                        <p class="">Already have an account ?  <a href="{{ route('host.login') }}" class="text-primary ml-2">Sign In</a></p>
                    </div>
                </div><!--end card-body-->
            </div><!--end card-->
