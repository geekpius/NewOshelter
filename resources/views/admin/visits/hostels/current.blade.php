            ...
            <div class="col-sm-12">
                ...
                <div class="card-body pt-12">
                    ...
                    <ul class="nav nav-tabs nav-justified" role="tablist">
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link active text-primary font-weight-500" href="{{ route('visits.hostel.current') }}" role="tab">Current</a>
                        </li>
                        <li class="nav-item waves-effect waves-light">
                        ...
                        <div class="tab-pane active p-3" id="all" role="tabpanel">
                            <div class="table-responsive dash-social">
                                <table id="datatable" class="table table-bordered">
                                    ...
                                    <tbody>
                                        @foreach (Auth::user()->userHostelVisits->where('check_in','<',\Carbon\Carbon::today())->where('check_out','>',\Carbon\Carbon::today()) as $visit)
                                        <tr>
