...
<div class="slimscroll notification-list">
    ...
    @foreach ($hostels as $item)
       <!-- item-->
       <a href="{{ route('requests.detail.hostel', $item->id) }}" class="dropdown-item notify-item active">
            <div class="notify-icon bg-success"><i class="fa fa-exchange-alt"></i></div>
    ...
    @foreach ($hostels_confirms as $item)
       <!-- item-->
       <a href="{{ route('requests.payment.hostel', $item->id) }}" class="dropdown-item notify-item active">
            <div class="notify-icon bg-success"><i class="fa fa-money-bill"></i></div>
            <p class="notify-details">Payment Request<small class="text-muted">Pending</small></p>
        </a> 
    @endforeach
