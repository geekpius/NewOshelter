                        ...
                        <table id="datatable" class="table">
                            ...
                            @foreach ($tickets as $tick)
                                <tr class="record">
                                    ...
                                    <td>                                                       
                                        <a href="{{ route('ticket.read', $tick->id) }}" class="mr-3" title="View"><i class="fa fa-eye text-primary font-16"></i></a>
                                        @if (!$tick->status)
                                        <a href="javascript:void(0);" data-id="{{ $tick->id }}" data-href="{{ route('ticket.close',$tick->id) }}" class="btnClose" title="Close"><i class="fas fa-times-circle text-danger font-16"></i></a>
                                        @endif
                                    </td>
                                </tr><!--end tr-->
                            @endforeach                                       
