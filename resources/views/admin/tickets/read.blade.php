        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active">Read Support</li>
                    </ol>
                </div>
                <h4 class="page-title">Read Support</h4>
            ...
            <div class="col-sm-8">
                <div class="card-body">
                    ...
                    <div class="card mb-4 p-4">
                        <div class="row">
                            <div class="col-sm-4">
                                <img src="{{ (empty(Auth::user()->image))? asset('assets/images/users.jpg'):asset('assets/images/users/'.Auth::user()->image) }}" alt="{{ current(explode(' ',Auth::user()->name)) }}" class="rounded-circle thumb-lg m-2" /> 
