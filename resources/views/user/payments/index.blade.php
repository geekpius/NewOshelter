                    ...
                    <div class="card-deck mb-3 text-center">
                        ...
                        <div class="card mb-4 box-shadow">
                            ...
                            <div class="card-body">
                                ...
                                <button type="button" data-href="{{ route('payment.show', $package->external_id) }}" class="btn btn-lg btn-block btnSubscribe {{ (strtolower($package->package_name) == 'default')? 'btn-outline-primary':'btn-primary' }}" {{ (strtolower($package->package_name) == 'default')? 'disabled':'' }}>Subscribe</button>
                            </div>
                        </div>
                        @endforeach
