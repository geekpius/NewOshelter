                ...
                <ul class="list-unstyled topbar-nav float-right mb-0"> 
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="#"><i class="dripicons-user text-muted mr-2"></i> Visits</a>
                ...
                <div class="main-menu-inner">
                    <div class="menu-body slimscroll">
                        ...
                        <div id="MetricaTenant" class="main-icon-menu-pane">
                            ...
                            <ul class="nav">
                                <li class="nav-item"><a class="nav-link" href="{{route('tenant')}}"><i class="dripicons-user-id"></i>List Tenants</a></li>
