                ...
                <ul class="list-unstyled topbar-nav float-right mb-0"> 
                    ...
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                            aria-haspopup="false" aria-expanded="false">
                            <img src="{{ (empty(Auth::user()->image))? asset('assets/images/tenants/user-4.jpg'):asset('assets/images/tenants/'.Auth::user()->image) }}" alt="profile-user" class="rounded-circle img_preview" /> 
                ...
                <div class="main-menu-inner">
                    <div class="menu-body slimscroll">
                        ...
                        <div id="MetricaProperty" class="main-icon-menu-pane">
                            ...
                            <ul class="nav">
                                <li class="nav-item"><a class="nav-link" href="{{ route('guest.property.rent') }}"><i class="fa fa-list-alt"></i>Rented Properties</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{route('guest.property.buy')}}"><i class="dripicons-wallet"></i>Bought Properties</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{route('guest.property.bid')}}"><i class="dripicons-wallet"></i>Bidden Properties</a></li>
                            </ul>
                        </div><!-- end Crypto -->
                        <div id="MetricaMessage" class="main-icon-menu-pane">
                            ...
                            <ul class="nav">
                                @if (Route::currentRouteName('guest.messages.compose'))
                                <li class="nav-item" style="display:none !important"><a class="nav-link" href="{{route('guest.messages.compose', 1)}}"><i class="dripicons-mail"></i>Compose Message</a></li>                                    
                                @endif
                                <li class="nav-item"><a class="nav-link" href="{{route('guest.messages')}}"><i class="dripicons-inbox"></i>Messages</a></li>
                            </ul>
                        </div><!-- end Ecommerce -->
                        <div id="MetricaSupport" class="main-icon-menu-pane">
                            ...
                            <ul class="nav">
                                <li class="nav-item"><a class="nav-link" href="{{route('guest.ticket')}}"><i class="mdi mdi-ticket"></i>New Ticket</a></li>
                                <li class="nav-item"><a class="nav-link" href="{{route('guest.ticket.view')}}"><i class="mdi mdi-ticket-outline"></i>View All Tickets</a></li>
                                @if (Route::currentRouteNamed('guest.ticket.read'))
                                <li class="nav-item" style="display:none !important"><a class="nav-link" href="{{ route('guest.ticket.read',1) }}"><i class="mdi mdi-ticket-outline"></i></a></li>  
                                @endif
