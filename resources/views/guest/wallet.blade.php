...
<div class="container-fluid">
            ...
            <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="text-center mt-4">
                                <button class="btn btn-gradient-primary btn-sm px-3 btnReceive" data-toggle="modal" data-target="#receiveModal">Receive To Wallet</button>
                            </div>
                        </div>                                        
                    </div>                                               
                </div><!--end card-body-->
                ...
                <div class="card-body pt-4">
                    ...
                    <ul class="nav nav-pills nav-justified" role="tablist">
                        ...
                        <li class="nav-item waves-effect waves-light">
                            <a class="nav-link" data-toggle="tab" href="#paid" role="tab">Payment</a>
                        </li>
                    </ul>
                                ...
                                <table id="datatable" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="badge badge-md badge-soft-danger">Paid for rent</span></td>
                                            <td>{{Auth::user()->userWallet->currency}} 990.00</td>
                                        </tr><!--end tr-->                                                                                    
                                    </tbody>
                                </table>                    
    ...
    <!-- receive modal -->
    <div id="receiveModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="receiveModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="receiveModalLabel">Receive To Wallet</h5>
                ...
                <div class="modal-body">
                    <form id="formReceive">
                        ...
                        <div class="form-group text-right">
                            <button type="submit" class="btn btn-gradient-success btnReceiveSubmit">Submit</button>
                        </div>
                    </form>                    
                </div>
            </div><!-- /.modal-content -->
...
$("#formReceive").on("submit", function(e){
    ...
    var $this = $(this);
    var valid = true;
    var oldAmount = $("#formReceive #old_amount").val();
    var amount = $("#formReceive #amount").val();
    if(amount==''){
        $("#formReceive #amount").parents('.validate').find('.mySpan').text("The amount field is required");
    }
    else if(parseFloat(amount)==0){
        $("#formReceive #amount").parents('.validate').find('.mySpan').text("Zero amount not allowed");
    }else if(parseFloat(amount)>parseFloat(oldAmount)){
        $("#formReceive #amount").parents('.validate').find('.mySpan').text("Not enough balance");
    }
