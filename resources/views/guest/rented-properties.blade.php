    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <div class="mb-3"> 
                        <a href="javascript:void(0);" class="mr-4"> {{Auth::user()->name}} Rented Properties </a>
                    </div>
                    @if (count(Auth::user()->propertyRents))
                    <div class="row">
                        @foreach (Auth::user()->propertyRents as $rent)
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="blog-card">
                                        <a href="{{ route('host.property.preview', $rent->property->id) }}">
                                            <img src="{{ asset('assets/images/properties/'.$rent->property->propertyImages->first()->image) }}" alt="PropertyPhoto" class="img-fluid">
                                        </a>
                                        <div class="meta-box">            
                                            <h5 class="mt-3">
                                                <a href="{{ route('host.property.preview', $rent->property->id) }}" class="text-primary">{{ $rent->property->title }}</a>
                                            </h5>
                    ...
                    <div class="text-center mt-5 mb-3">
                        <div class="alert icon-custom-alert alert-outline-pink b-round fade show" role="alert">                                            
                            ...
                            <div class="alert-text">
                                <strong>None!</strong> No property found in your lists. You can rent new property now.
                            </div>
