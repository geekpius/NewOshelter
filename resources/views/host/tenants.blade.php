        ...
        <div class="col-sm-12">
            <div class="page-title-box">
                <div class="float-right">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active">List Tenants</li>
                    </ol>
                </div>
                <h4 class="page-title">List Tenants</h4>
                        ...
                        <table id="datatable" class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>68</td>
                                    <td>                                                       
                                        <a href="{{route('host.tenant.rented', 1)}}" class="mr-3" title="Properties Rented"><i class="fas fa-home text-primary font-16"></i></a>
                                ...
                                <tr>
                                    ...
                                    <td>112</td>
                                    <td>                                                       
                                        <a href="{{route('host.tenant.rented', 2)}}" class="mr-3" title="Properties Rented"><i class="fas fa-home text-primary font-16"></i></a>
                                        <a href="#" title="Send Email"><i class="fas fa-envelope text-pink font-16"></i></a>
                                    </td>
                                </tr><!--end tr-->
