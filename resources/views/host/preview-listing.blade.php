                ...
                <div class="card-body">
                    <div class="text-center">
                        @if ($property->done_step)
                            <a href="javascript:void(0);" class="mr-4 text-primary" onclick="window.location='{{ route('host.property') }}';"><i class="fa fa-backward"></i> Go Back</a>
                            <a href="javascript:void(0);" class="mr-2 text-pink"><i class="fa fa-heart"></i> Save</a>
                        @else    
                            <a href="javascript:void(0);" onclick="window.location='{{ route('host.property.create', $property->id) }}';" class="mr-2 text-pink"><i class="fa fa-heart"></i> Save</a>
                        @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-sm-8">
                            ...
                            <div class="img-right mr-lg-5 mr-sm-5 text-center">
                                <img src="{{ (empty($property->admin->image))? asset('assets/images/users/user-4.jpg'):asset('assets/images/users/'.$property->admin->image) }}" alt="{{ current(explode(' ',$property->admin->name)) }}"  class="thumb-lg rounded-circle" /> 
                                <p>{{ current(explode(' ',$property->admin->name)) }}</p>
                            </div>
                            <h3>
                                <b>{{ $property->title }}</b>
                                @if (!$property->done_step) 
                                (<a href="{{ route('host.property.edit', $property->id) }}" class="text-primary"><i class="fa fa-edit"></i> Edit Listing</a>)
                                @endif
                            </h3>
                            ...
                            @else
                                ...
                                <p>Give the star {{ current(explode(' ',$property->admin->name)) }}'s property deserve</p> <hr>
                            @endif
                            <!-- Refund policy -->
                            <div class="mt-5">
                            ...
                            <h4><b>Lordship by {{ current(explode(' ',$property->admin->name)) }}</b></h4>                           
