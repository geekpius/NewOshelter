...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="">
                    <a href="javascript:void(0);" onclick="window.location='{{ route('host.property.add') }}'" class="text-primary ml-3 mt-1">
                        ...
                        <div class="step-content pos-rel">  
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <div style="position: relative;  height: 550px; overflow-y:scroll; overflow-x:hidden;">
                                                <form class="mt-4" id="formBlockRooms" method="POST" action="{{ route("host.property.store") }}">
                                                    @csrf
                                ...
                                <div class="step-pane active" data-step="1">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5">
                                            ...
                                            <form class="mt-4" id="formContainAmenities" method="POST" action="{{ route("host.property.store") }}">
                                                @csrf
                                                <input type="hidden" name="property_id" value="{{ $property->id }}" readonly>
                                                <input type="hidden" name="step" value="1" readonly>
                                                <div class="form-group mt-4 validate">
                            ...
                            <div class="step-pane" data-step="2">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <form class="mt-4" id="formLocationLandmark" method="POST" action="{{ route('host.property.store') }}">
                                            @csrf
                            ...
                            <div class="step-pane" data-step="3">
                                <div class="row">
                                    <div class="col-lg-1"></div>
                                    <div class="col-lg-11">
                                        <form class="mt-4" id="formAmenities" method="POST" action="{{ route('host.property.store') }}">
                            ...
                            <div class="step-pane" data-step="4">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <form id="formPhotos" class="hidden" method="POST" action="{{ route('host.property.store') }}">
                                            @csrf
                            ...
                            <div class="step-pane" data-step="5">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <form class="mt-4" id="formDescriptions" method="POST" action="{{ route('host.property.store') }}">
                                            @csrf
                            ...
                            <div class="step-pane" data-step="6">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        @endif
                                        <form class="mt-4" id="formPropertyRules" method="POST" action="{{ route('host.property.store') }}">
                                            @csrf
                            ...
                            <div class="step-pane" data-step="7">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <form id="formHostelSchedule" method="POST" action="{{ route('host.property.store') }}" style="display: none !important">
                                            @csrf
                                            <input type="hidden" name="step" value="7" readonly>
                                            <input type="hidden" name="property_id" value="{{ $property->id }}" readonly>
                                        </form>
                            ...
                            <div class="step-pane" data-step="7">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        @endif
                                        <form class="mt-4" id="formRentSchedule" method="POST" action="{{ route('host.property.store') }}">
                                            @csrf
                                            <input type="hidden" name="step" value="7" readonly>
                                            <input type="hidden" name="property_id" value="{{ $property->id }}" readonly>
                                            @if($property->type_status=='rent')
                            ...
                            <div class="step-pane" data-step="8">
                                <div class="row">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <form id="formTenantGuide" method="POST" action="{{ route('host.property.store') }}" style="display:none">
                                            @csrf
                            ...
                            <div class="step-pane" data-step="9">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <form id="formFinishListing" method="POST" action="{{ route('host.property.store') }}" style="display:none">
                                            @csrf
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <div class="card mt-3 float-right">
                                            <div class="card-body">        
                                                <a href="{{ route('host.property.preview', $property->id) }}" class="text-primary">
...
$(".btnAddBlock").on("click", function(){
    ...
    if(valid){
        ...
        $.ajax({
            url: "{{ route('host.property.block.submit') }}",
            type: "POST",
            data: data,
...
function showBlocks(id){
    $.ajax({
        url: "{{ url('/landlord/properties/block') }}/"+id+"/show",
        type: "GET",
        success: function(resp){
...
$("#upfile").on("change", function(){
    ...
    if(totalfiles>10){
        ...
        $.ajax({
            url: "{{ route('host.property.photos.submit') }}", 
            type: 'POST',
            data: form_data,
            contentType: false,
            processData: false,
            success: function (response) {
                if(response=='exceed'){
                    ...
                    $("#propertyPhotoHolder").load("{{ route('host.property.photos.show',$property->id) }}");
                }
                document.getElementById("upfile").value = null;
                $("#uploadMsg").html('');
            },
...
///load all own rules
$("#myDefineRules").load("{{ route('host.property.rule.show', $property->id) }}");
...
$(".btnAddOwnRule").on("click", function(e){
    ...
    if(valid){
        ...
        $.ajax({
            url: "{{ route('host.property.rule.submit') }}",
            type: "POST",
            data: data,
            success: function(resp){
                if(resp=='success'){
...
$("#formRentSchedule").on("submit", function(e){
    ...
    if(valid){
        ...
        $.ajax({
            url: "{{ route('host.property.blockprice.submit') }}",
            type: "POST",
            data: data,
            success: function(resp){
                if(resp=='success'){
                    $("#getMyBlockPrices").load("{{ route('host.property.blockprice.show', $property->id) }}");
